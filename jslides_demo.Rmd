...
output:
  xaringan::moon_reader:
    css: 'https://jhelvy.github.io/jslides/jslides.css'
    lib_dir: libs
    nature:
...
# .center[Images have a thin border by default]

.leftcol[
This code produces the image on the right:
```{r, eval=FALSE}
<center>
<img src="images/prof_x.gif" width="400">
</center>
```
]
.rightcol[
...
# Remove the border with .code100[`.noborder[]`]
